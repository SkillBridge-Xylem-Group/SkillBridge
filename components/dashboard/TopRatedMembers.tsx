...
// Sorted by rating, highest first — this is a general leaderboard-style
// list, not a personalized recommendation.
  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-extrabold text-slate-900">Top Rated Members</h2>
      ...
      <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-3">
        {members.map((m) => (
          <div key={m.name} className="rounded-2xl border border-slate-100 p-5">
            ...
            <p className="mt-3 text-xs font-semibold text-brand">Offers help in {m.offersHelpIn}</p>
